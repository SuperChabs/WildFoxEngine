...
const std::vector<MaterialConfig> &MaterialConfigLoader::LoadMaterialConfigs(
...
const std::vector<MaterialConfig> &MaterialConfigLoader::GetConfigs() const {
    return materialConfigs;
}

glm::vec3 MaterialConfigLoader::ParseColor(const json &colorArray) {
