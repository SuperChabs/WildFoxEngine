...
GLuint ShaderCompiler::CompileShader(std::string vertexCode, std::string fragmentCode, std::string geometryCode) {
...
void ShaderCompiler::CheckCompileErrors(unsigned int obj, const std::string &type) {
    int ok = 0;
    char log[1024];
